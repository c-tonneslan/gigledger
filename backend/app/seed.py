...
CATEGORIES = [
    ...
    # schedule_c_line uses IRS line numbers from the 2024 Schedule C revision.
    ("1099 Income", "1", False, False, "Gross self-employment income"),
    ("W2 Income", None, False, False, "Wages from an employer"),
    ("Other Income", "6", False, False, "Interest, refunds, etc."),
    ("Software & Subscriptions", "18", False, True, "SaaS tools used for work"),
    ("Equipment", "13", True, True, "Computers, monitors, peripherals over $200"),
    ("Office Supplies", "22", False, True, "Small consumables"),
    ("Internet & Phone", "25", False, True, "Home office utilities pro-rated"),
    ("Home Office", "30", False, True, "Rent / utilities allocation"),
    ("Travel", "24a", False, True, "Flights, hotels, transit for work"),
    ("Meals", "24b", False, True, "50% deductible meals"),
    ("Professional Services", "17", False, True, "CPA, lawyer, contractors"),
    ("Health Insurance", "Sch 1 · 17", False, True, "Self-employed health insurance (above-the-line on Schedule 1)"),
    ("Retirement (SEP-IRA)", "Sch 1 · 16", False, True, "SEP / Solo 401(k) contributions (above-the-line on Schedule 1)"),
